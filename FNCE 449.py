...
def calculate_m2m_portfolio(leveraged_etf_mapping, testing_start_date, testing_end_date):
    ...
    for ticker in leveraged_etf_mapping.keys():
        ...
        lev_prices = get_prices([Long_2x, Short_2x], testing_start_date, testing_end_date)
...
def calculate_and_plot_m2m_portfolio(leveraged_etf_mapping, sensitivity_df, testing_start_date, testing_end_date):
    ...
    all_prices = get_prices(list(all_etfs), testing_start_date, testing_end_date)
...
if __name__ == "__main__":
    ...
    leveraged_etf_mapping = {
        ...
        #"QQQ": {"Long 2x": "TQQQ", "Short 2x": "SQQQ"},    # Nasdaq 100 Not includes in the report
        #"DIA" : {"Long 2x": "DDM", "Short 2x": "DXD"},    # Dow 30 Not includes in the report
        #"IYE" : {"Long 2x": "DIG", "Short 2x": "DUG"}     # Oil & gas Not includes in the report
    }
